...
import { CfiDashboardClient } from "@/components/admin/CfiDashboardClient";

export default async function ClinicalFidelityPage() {
  await requireAdmin();
  const t = await getTranslations("admin.cfi");
