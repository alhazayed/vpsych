...
const AVATAR_DEFAULT_DISORDER_SLUG: Record<string, string> = {
  ...
  // Wave-2 Simulated Patient Library
  "aisha-rahman": "panic-disorder",
  "wesley-croft": "panic-disorder",
  "marisol-guevara": "complex-ptsd",
  "alan-whitfield": "pdd",
  "kai-mori": "asd",
  "dorothy-kim": "mdd-recurrent-moderate",
  "harold-pence": "delirium",
  "jamal-reed": "mdd-recurrent-moderate",
  "fatima-nassar": "schizoaffective",
  "owen-bradley": "bipolar-mania",
  "priya-desai": "eating-disorders",
  "cameron-blake": "social-anxiety",
  "mila-santos": "gad-with-panic",
  "brenda-yates": "gad-with-panic",
  "noah-kimura": "gad-with-panic",
  "diego-alvarez": "alcohol-use-disorder",
  "andrea-volkov": "mdd-recurrent-moderate",
  "yasmin-hakimi": "ptsd",
  "richard-okada": "mdd-recurrent-moderate",
  "sam-quinn": "mdd-recurrent-moderate",
  "marcus-pellegrini": "mdd-recurrent-moderate",
  "helen-croft": "mdd-recurrent-moderate",
  "isaac-moore": "schizophrenia",
  "geraldine-moss": "ocd",
  "linda-cho": "mdd-recurrent-moderate",
  "nadia-farouk": "ptsd",
  "vincent-rossi": "mdd-recurrent-moderate",
  "zoe-carter": "mdd-recurrent-moderate",
  "arthur-bell": "mdd-recurrent-moderate",
  "raven-solis": "complex-ptsd",
  "terry-hughes": "alcohol-use-disorder",
  "jade-whitmore": "bpd",
  "simon-park": "gad-with-panic",
  "amelia-frost": "bipolar-mania",
  "logan-pierce": "eating-disorders",
  "billy-ray-cobb": "mdd-recurrent-moderate",
  "victoria-ashford": "mdd-recurrent-moderate",
  "careen-shaw": "mdd-recurrent-moderate",
};
