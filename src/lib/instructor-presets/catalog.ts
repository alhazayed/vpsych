...
export const BUILTIN_PRESETS: InstructorPreset[] = [
  ...
  },
  {
    ...
    required_competencies: [
      {
        competency_id: "clinical_communication",
      ...
      {
        competency_id: "mental_status_examination",
  ...
  },
  {
    ...
    advanced_mode: false,
    scenario_template_slug: "adult-mdd-initial-en",
    preferred_template_slugs: ["adult-mdd-initial-en", "adult-gad-osce-ar"],
    clinical_constraints: [],
    required_competencies: [
      {
        competency_id: "therapeutic_alliance",
  ...
  },
  {
    ...
    secondary_objectives: ["psychoeducation", "substance_use_assessment"],
    difficulty: "intermediate",
  ...
  },
  {
    ...
    grading: {
      ...
      automatic_deductions: { missed_si: 25 },
      dimensions: [
        "diagnostic_accuracy",
        "dsm_reasoning",
        "differential",
