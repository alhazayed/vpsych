...
- **Arabic Speech Preparation Engine (ASPE)** (`src/lib/arabic-speech/`, `docs/ARABIC_SPEECH_PREPARATION_ENGINE.md`): deterministic TTS orthography for Arabic — selective clinical tashkeel, number/abbreviation expansion; wired into `/api/voice/tts` without mutating stored transcripts.
