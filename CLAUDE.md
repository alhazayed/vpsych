...
| Arabic Speech Preparation (ASPE) | `lib/arabic-speech/` | `docs/ARABIC_SPEECH_PREPARATION_ENGINE.md` |
...
ontology and clinical knowledge model),
`docs/runtime/COGNITIVE_ARCHITECTURE.md` (Stage 4 — one-mind orchestration,
contracts, state machine), `docs/ARCHITECTURE_CERTIFICATION.md`,
