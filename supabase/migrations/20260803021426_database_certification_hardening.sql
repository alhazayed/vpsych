...
-- ---------------------------------------------------------------------------
-- 1) Anon must not hold DML on public tables (RLS is necessary but not
--    sufficient defense-in-depth). Authenticated keeps existing grants.
-- ---------------------------------------------------------------------------
...
-- Compatibility views (ACE→CGE aliases) inherit underlying RLS via security_invoker.
REVOKE ALL ON TABLE
...
-- ---------------------------------------------------------------------------
-- 2) Policies that targeted PUBLIC (includes anon) → authenticated only.
--    Predicate logic unchanged.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3) Hot-path FK covering indexes (session / learner joins)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 4) Trigger helpers are not RPC entrypoints — revoke broad EXECUTE
-- ---------------------------------------------------------------------------
